...
def get_args() :
    ...
    parser.add_argument('--name', default="pd_separate", type = str , help= 'Name for campaign to run') 
    ...
    parser.add_argument('--config_path', default="experiment_configs/pd-separate.json", type = str, help= 'Name for campaign to run') 
