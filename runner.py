...
def get_args() :
    ...
    parser.add_argument('--name', default="pd_contract", type = str , help= 'Name for campaign to run') 
    ...
    parser.add_argument('--config_path', default="experiment_configs/pd-contract.json", type = str, help= 'Name for campaign to run') 
